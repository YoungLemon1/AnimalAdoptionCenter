    ...
    public class AACContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Animal>().HasData(
                ...
                new Animal { Id = 8, CategoryId = 3, SubCategory = "Parrot", Name = "Yusuf", Age = 23, CityId = 4, Sex = eSex.Male, Size = eSize.Small, Status = eStatus.Ready_For_Adoption, IsVaccinated = true, IsTrained = true, IsSterilized = false, ProfileImagePath = "\\Images\\Animals\\Asi.jpg", Description = "Very friendly parrot, fitting for small houses" },
                new Animal { Id = 9, CategoryId = 4, SubCategory = "Frog", Name = "Froggy", Age = 5, CityId = 4, Sex = eSex.Male, Size = eSize.Tiny, Status = eStatus.Ready_For_Adoption, IsVaccinated = false, IsTrained = false, IsSterilized = false, ProfileImagePath = "https://a-z-animals.com/media/2021/11/tree-frog.jpg" }
                );
